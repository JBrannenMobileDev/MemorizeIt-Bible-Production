...
public class MyVerse extends RealmObject implements Parcelable{
    private String verse;
    @PrimaryKey private String verseLocation;
    ...
    public MyVerse(String verse, String verseLocation) {
        setVerse(verse);
